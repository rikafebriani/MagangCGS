            ...
            <div class="panel panel-trans">
                <div class="pad-all">
                    <div class="media mar-btm">
                        <div class="media-left">
                            <img src="{{ asset('assets/img/profile-photos/2.png') }}" class="img-md img-circle"
                                alt="Avatar">
                        </div>
                        <div class="media-body">
                    ...
                    <blockquote class="bq-sm bq-open bq-close">Lorem ipsum dolor sit amet, consecte tuer adipiscing elit,
                        sed diam nonummy nibh euismod tincidunt.</blockquote>
                </div>
                <div class="bord-top">
