                            ...
                            <ul class="head-list">
                                ...
                                <li>
                                    <a class="media" href="#">
                                        ...
                                        <div class="media-body">
                                            <p class="mar-no text-nowrap text-main text-semibold">Write a news article
                                            </p>
                                ...
                                <li>
                                    <a class="media" href="#">
                                        ...
                                        <div class="media-body">
                                            <p class="mar-no text-nowrap text-main text-semibold">New User Registered
                                            </p>
                                ...
                                <li>
                                    <a class="media" href="#">
                                        ...
                                        <div class="media-body">
                                            <p class="mar-no text-nowrap text-main text-semibold">Lucy sent you a
                                                message</p>
                                ...
                                <li>
                                    <a class="media" href="#">
                                        ...
                                        <div class="media-body">
                                            <p class="mar-no text-nowrap text-main text-semibold">Jackson sent you a
                                                message</p>
