            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                ...
                @else
                    <a href="{{ route('login') }}"
                        ...
                        in Admin</a>
                    <a href="{{ route('jurusan.login') }}"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log
                        in Jurusan</a>
                    <a href="{{ route('dosen.login') }}"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log
                        in Dosen</a>
                    <br>
            ...
            <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right">
                @auth
                    <a href="{{ url('/dashboard') }}"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Home</a>
                @else
                    <a href="{{ route('login') }}" style="display: block; margin-bottom: 8px;"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log
                        in Admin</a>
                    <a href="{{ route('jurusan.login') }}" style="display: block; margin-bottom: 8px;"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log
                        in Jurusan</a>
                    <a href="{{ route('dosen.login') }}" style="display: block; margin-bottom: 8px;"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log
                        in Dosen</a>
                    <a href="{{ route('mahasiswa.login') }}" style="display: block; margin-bottom: 8px;"
                        class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Log
                        in Mahasiswa</a>

                    @if (Route::has('register'))
                        <a href="{{ route('register') }}" style="display: block; margin-top: 16px;"
